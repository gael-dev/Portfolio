...
$headers = 'From: MESSAGE DU SITE Gael-dev<https://gael-dev.github.io/Portfolio/>'."rn";
$headers .= "rn";
/*L'envoi du mail - Et page de redirection*/
mail($to, $sujet, $msg, $headers);
header('Location:https://gael-dev.github.io/Portfolio/port/public/pages/contactez-moi.html');
}
else
{
header('Location:https://gael-dev.github.io/Portfolio/port/public/pages/contactez-moi.html');
